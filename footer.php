    ...
    <div class="footer-content">
      <div class="common-title footer-title">
        <div class="common-title-main">
          <img class="<?php echo get_template_directory_uri(); ?>/title-side-left" src="images/title-side.png">
          <h2>ご気軽にご来院ください</h2>
          <img class="<?php echo get_template_directory_uri(); ?>/title-side-right" src="images/title-side.png">
        </div>
        </div>
      ...
      <div class="footer-nav">
        ...
        <div class="footer-nav-navi">
          ...
          <a href="<?php echo get_template_directory_uri(); ?>/aboutus.html">当院について</a>
          <a href="<?php echo get_template_directory_uri(); ?>/course-price.html">コース・料金</a>
          <a href="<?php echo get_template_directory_uri(); ?>/information.html">お知らせ</a>
          <a href="<?php echo get_template_directory_uri(); ?>/voice.html">お客様の声</a>
          <a href="<?php echo get_template_directory_uri(); ?>/contact.html">ご予約・お問い合わせ</a>
        </div>
      </div>
    <div class="copyright">
